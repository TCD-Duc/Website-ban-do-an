...
//Thêm sự kiện đóng/mở cho section
...
function showProduct() {
    ...
    let products = localStorage.getItem("products") ? JSON.parse(localStorage.getItem("products")) : [];
    //Lọc sản phẩm dựa trên trạng thái
    if(selectOp == "Tất cả") {
